...
private:
	...
	void splitImage(const cv::Mat *const image, const int *const int col_num, 
	                const int *const int row_num, std::vector<cv::Mat> *const image_vec);
	/*
