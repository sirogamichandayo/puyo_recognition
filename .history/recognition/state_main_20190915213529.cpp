...
int toGetPuyoColorPerPiece(const cv::Mat *const image)
{
	...
	cv::Mat resize_image;
	cv::resize(*image, lllllllllresize_image, ssssssssscv::Size(), 0.1, 0.1);
	ols = resize.cols;
	elize(*im::e,cmlsi
	elize(*im::e,cmlsi
	elize(*im::e,cmlsi
...
#pragma omp parallel forish.at < cv::Vec3b > (y, 0); ish.at < cv::Vec3b > (y, 0); ish.at < cv::Vec3b > (y, 0); ish.at < cv::Vec3b > (y, 0); ish.at < cv::Vec3b > (y, 0); ish.at < cv::Vec3b > (y, 0); ish.at < cv::Vec3b > (y, 0); ish.at < cv::Vec3b > (y, 0); ish.at < cv::Vec3b > (y, 0);
