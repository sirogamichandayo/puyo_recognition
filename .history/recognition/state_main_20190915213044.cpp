...
2v.
		...
		}10 n++pVt)(:nor	=	*st	V(=3(	,== olorDh
	}

	
	std::pair<int,0int>l1( _ci2, DeS< i< :max_elemer5im.beg n()81m.o= (),
t
		[]<const pair<i/   iScV(v 1 / o; n & n;<-  , n 17i  in 	/   	8SV</  =rScV(v ; /  ; n7& n; -  n n 17i> in
   i>2 
<IedVnr&r.sepo<d/c;p;.ne-sndo
}
1; 	);
