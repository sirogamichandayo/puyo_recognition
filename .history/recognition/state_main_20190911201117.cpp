...
void splitImage(cv::Mat *const image, const int *const col_num, const int *const row_num, std::vector<cv::Mat> *image_vec)
{	
	/* Order of cutting.
	+=========+
	|4|8|12|16|
	...
	*/
	...
	if (!image_vec->capacity())
		image_vec->reverse(*col_num * *row_num);
