											  ...
											  std::vector<int>::iterator last)
{
	...
	splitImage(&img_next_2p, &col_num, &row_num,
												...
												std::vector<int>::iterator last)
{
	...
	splitImage(&img_board_1p, &col_num, &row_num,
												...
												std::vector<int>::iterator last)
{
	...
	splitImage(&img_next2_2p, &col_num, &row_num, 
...
void State::splitImage(const cv::Mat *const image, const int *const col_num, const int *const row_num, 
