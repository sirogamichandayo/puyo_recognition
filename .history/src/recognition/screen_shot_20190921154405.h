...
nnnconst cv::Rect next2_1p = cv::Rect(771, 295, pic::SMALL_PUYO_WIDTH, pic::SMALL_PUYO_HEIGHT * 2);
...
// nnconst cv::vector<int> delta()
constn cv::Rect hisya = cv::Rect(18, 104, 1570, 883);
...
public:
	...
	static ScreenShot getScreenShot(std::string str)
	{
